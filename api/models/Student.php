...
class Student {
    ...
    public function create($data) {
        ...
        try {
            ...
            $stmt = $this->pdo->prepare($sql);
            $stmt->execute([$this->school_id, $data['student_number'], $data['first_name'], $data['last_name'], $data['date_of_birth'] ?? null, $data['gender'] ?? null, $data['phone'] ?? null, $data['email'] ?? null, 'active']);
    ...
    public function update($id, $data) {
        ...
        try {
            ...
            $stmt = $this->pdo->prepare($sql);
            $stmt->execute([$data['first_name'], $data['last_name'], $data['date_of_birth'] ?? null, $data['gender'] ?? null, $data['phone'] ?? null, $data['email'] ?? null, $data['status'] ?? 'active', $id, $this->school_id]);
